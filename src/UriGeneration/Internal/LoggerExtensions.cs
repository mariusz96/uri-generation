...
namespace UriGeneration.Internal
{
    internal static partial class LoggerExtensions
    {
        ...
        [LoggerMessage(1005, LogLevel.Debug, "Successfully retrieved valid method cache entry for action: {ActionName}.", EventName = nameof(ValidCacheEntryRetrieved))]
        public static partial void ValidCacheEntryRetrieved(this ILogger logger, string? actionName);

        [LoggerMessage(1006, LogLevel.Debug, "Successfully retrieved invalid method cache entry: no values will be extracted (see previous log messages for further details).", EventName = nameof(InvalidCacheEntryRetrieved))]
        ...
        [LoggerMessage(1013, LogLevel.Debug, "Parameter: {ParameterName} cannot have binding source: {BindingSourceName}.", EventName = nameof(DisallowedBindingSource))]
        public static partial void DisallowedBindingSource(this ILogger logger, string parameterName, string? bindingSourceName);
