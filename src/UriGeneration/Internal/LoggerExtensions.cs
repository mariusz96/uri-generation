...
namespace UriGeneration.Internal
{
    internal static partial class LoggerExtensions
    {
        ...
        [LoggerMessage(1011, LogLevel.Debug, "Excluded method's parameter with position {MethodParameterPosition}: name cannot be null.", EventName = nameof(MethodParameterExcludedName))]
        public static partial void MethodParameterExcludedName(this ILogger logger, int methodParameterPosition);

        [LoggerMessage(1012, LogLevel.Debug, "Excluded method's parameter: {MethodParameterName} cannot be of Type IFormFile, IEnumerable<IFormFile>, CancellationToken or FormCollection.", EventName = nameof(MethodParameterExcludedType))]
        public static partial void MethodParameterExcludedType(this ILogger logger, string? methodParameterName);

        [LoggerMessage(1013, LogLevel.Debug, "Excluded method's parameter: {MethodParameterName} cannot have FromBody, FromForm, FromHeader or FromServices attribute specified.", EventName = nameof(MethodParameterExcludedAttribute))]
        public static partial void MethodParameterExcludedAttribute(this ILogger logger, string? methodParameterName);

        [LoggerMessage(1014, LogLevel.Debug, "Successfully extracted method's name: {MethodName}.", EventName = nameof(MethodNameExtracted))]
        public static partial void MethodNameExtracted(this ILogger logger, string methodName);
        
        [LoggerMessage(1015, LogLevel.Debug, "{MethodName} cannot have NonActionAttribute specified.", EventName = nameof(MethodNameNotExtracted))]
        public static partial void MethodNameNotExtracted(this ILogger logger, string methodName);

        [LoggerMessage(1016, LogLevel.Debug, "Succesfuly extracted controller's name: {ControllerName}.", EventName = nameof(ControllerNameExtracted))]
        public static partial void ControllerNameExtracted(this ILogger logger, string controllerName);
        
        [LoggerMessage(1017, LogLevel.Debug, "{ControllerName} cannot have NonControllerAttribute specified.", EventName = nameof(ControllerNameNotExtracted))]
        public static partial void ControllerNameNotExtracted(this ILogger logger, string controllerName);

        [LoggerMessage(1018, LogLevel.Debug, "Successfully extracted route value: {Key}, {Value}.", EventName = nameof(RouteValueExtracted))]
        public static partial void RouteValueExtracted(this ILogger logger, string? key, object? value);

        [LoggerMessage(1019, LogLevel.Debug, "Successfully extracted all values from expression.", EventName = nameof(ValuesExtracted))]
        public static partial void ValuesExtracted(this ILogger logger);

        [LoggerMessage(1020, LogLevel.Debug, "Failed to extract one or more values from expression {Expression}: an exception occurred.", EventName = nameof(ValuesNotExtracted))]
