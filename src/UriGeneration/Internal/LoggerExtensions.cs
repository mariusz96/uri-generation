...
namespace UriGeneration.Internal
{
    internal static partial class LoggerExtensions
    {
        ...
        [LoggerMessage(1012, LogLevel.Debug, "Excluded method's parameter with position {MethodParameterPosition}: name cannot be null.", EventName = nameof(MethodParameterExcludedName))]
        public static partial void MethodParameterExcludedName(this ILogger logger, int methodParameterPosition);

        [LoggerMessage(1013, LogLevel.Debug, "Excluded method's parameter: {MethodParameterName} cannot be of Type IFormFile, IEnumerable<IFormFile>, CancellationToken or FormCollection.", EventName = nameof(MethodParameterExcludedType))]
        public static partial void MethodParameterExcludedType(this ILogger logger, string? methodParameterName);

        [LoggerMessage(1014, LogLevel.Debug, "Excluded method's parameter: {MethodParameterName} cannot have FromBody, FromForm, FromHeader or FromServices attribute specified.", EventName = nameof(MethodParameterExcludedAttribute))]
        ...
        [LoggerMessage(1016, LogLevel.Debug, "{MethodName} cannot have NonActionAttribute specified.", EventName = nameof(MethodNameNotExtracted))]
        ...
        [LoggerMessage(1018, LogLevel.Debug, "{ControllerName} cannot have NonControllerAttribute specified.", EventName = nameof(ControllerNameNotExtracted))]
